  ...
  return (
    <section className="relative min-h-dvh overflow-hidden bg-white lg:flex lg:min-h-screen lg:items-center lg:py-16">
      ...
      {/* Full-page background photo — a slow, continuous zoom (same
          ...
          little ambient life instead of sitting static. No scrim here
          by design: the photo shows fully. Legibility for the copy and
          buttons comes entirely from the white content card below, not
          from dimming the photo itself. */}
      ...
      {/* -mx-6 cancels Container's own mobile gutter so the panel runs
          edge-to-edge as a full-bleed translucent sheet on phones — the
          same "sheet below lg, inset card at lg" treatment used on
