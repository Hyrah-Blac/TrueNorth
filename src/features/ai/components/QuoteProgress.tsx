      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5">
        {CHECKLIST_ITEMS.map((item) => {
          ...
          return (
            <span
              key={item.key}
              className={`flex items-center gap-1.5 text-[11px] font-medium uppercase tracking-wide transition-colors duration-300 ease-editorial ${
        ...
        {isReady ? (
          <Link
            ...
            className="ml-auto animate-[fade-up_400ms_cubic-bezier(0.16,1,0.3,1)_both] rounded-full border border-blue-500 bg-blue-500 px-3 py-1.5 text-[11px] font-medium uppercase tracking-wide text-white transition-all duration-300 ease-editorial hover:-translate-y-0.5 hover:border-blue-700 hover:bg-blue-700 motion-reduce:animate-none"
          >
